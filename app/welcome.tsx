...
export default function LogIn() {
  ...
  return (
    <View className = "flex-1 bg-[#E9EDC9] content-center">
        <Text className="text-4xl font-baloo2 text-center p-4 border-2">Welcome!</Text>
    <Button onPress={() => router.push('/signup')}>
      <Text className ="bg-[#723D46] m-6 text-xl text-[#FEFAE0] p-2 px-10 rounded-full">Sign Up</Text>
    </Button>
